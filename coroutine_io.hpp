...
public:
    ...
    void restart() { should_continue_ = true; }
    void add_read_fd(int fd, Coroutine* co) { fd_to_coroutine_[fd] = co; }
...
inline thread_local std::unique_ptr<Scheduler> Scheduler::instance_;
inline bool HookSystem::initialized_ = false;
